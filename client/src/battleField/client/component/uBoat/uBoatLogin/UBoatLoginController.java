package battleField.client.component.uBoat.uBoatLogin;

import battleField.client.component.LoginController;
import battleField.client.component.global.chooseNameComponent.ChooseNameComponentController;
...
public class UBoatLoginController implements LoginController {
    ...
    public void initialize(){
        if(chooseNameComponentController != null) {
            ...
            chooseNameComponentController.initalize();
        }
        else{
