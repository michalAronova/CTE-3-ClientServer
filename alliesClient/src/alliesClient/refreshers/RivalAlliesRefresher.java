...
public class RivalAlliesRefresher extends TimerTask {
    ...
    public RivalAlliesRefresher(Consumer<List<Team>> rivalListConsumer, Boolean registeredToContest) {
        this.rivalListConsumer = rivalListConsumer;
        this.registeredToContest = new SimpleBooleanProperty(registeredToContest);
    }
