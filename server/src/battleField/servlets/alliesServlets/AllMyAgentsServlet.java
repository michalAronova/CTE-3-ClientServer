...
@WebServlet(name = "AllMyAgentsServlet", urlPatterns = {"/allies/all/agents"})

public class AllMyAgentsServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String json = gson.toJson(allies.getAllAgents());
