...
public class UBoatRefresher extends TimerTask {
    private final BooleanProperty shouldUpdate;

    public UBoatRefresher(IntegerProperty chatVersion, BooleanProperty shouldUpdate, Consumer<String> httpRequestLoggerConsumer) {
    ...
    public void run() {
        ...
        String finalUrl = HttpUrl
                .parse(Constants.CONTEST_STARTED)
                .newBuilder()
                .build()
                .toString();
/*
